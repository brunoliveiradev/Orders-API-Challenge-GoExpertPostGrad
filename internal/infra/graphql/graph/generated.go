...
func (ec *executionContext) field_Mutation_createOrder_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["order"]; ok {
		...
		arg0, err = ec.unmarshalOOrderInput2ᚖGoExpertPostGradᚑOrdersᚑChallengeᚋinternalᚋinfraᚋgraphqlᚋgraphᚋmodelᚐOrderInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOOrder2ᚖGoExpertPostGradᚑOrdersᚑChallengeᚋinternalᚋinfraᚋgraphqlᚋgraphᚋmodelᚐOrder(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_orders(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Order)
	fc.Result = res
	return ec.marshalNOrder2ᚕᚖGoExpertPostGradᚑOrdersᚑChallengeᚋinternalᚋinfraᚋgraphqlᚋgraphᚋmodelᚐOrderᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputOrderInput(ctx context.Context, obj interface{}) (model.OrderInput, error) {
	...
	fieldsInOrder := [...]string{"name", "price", "tax"}
...
func (ec *executionContext) marshalNOrder2ᚕᚖGoExpertPostGradᚑOrdersᚑChallengeᚋinternalᚋinfraᚋgraphqlᚋgraphᚋmodelᚐOrderᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Order) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNOrder2ᚖGoExpertPostGradᚑOrdersᚑChallengeᚋinternalᚋinfraᚋgraphqlᚋgraphᚋmodelᚐOrder(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNOrder2ᚖGoExpertPostGradᚑOrdersᚑChallengeᚋinternalᚋinfraᚋgraphqlᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOOrder2ᚖGoExpertPostGradᚑOrdersᚑChallengeᚋinternalᚋinfraᚋgraphqlᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Order(ctx, sel, v)
...
func (ec *executionContext) unmarshalOOrderInput2ᚖGoExpertPostGradᚑOrdersᚑChallengeᚋinternalᚋinfraᚋgraphqlᚋgraphᚋmodelᚐOrderInput(ctx context.Context, v interface{}) (*model.OrderInput, error) {
	if v == nil {
		return nil, nil
	}
